...
class ProductoModel
{
    ...
    /*public function actualizar($id_producto, $codigo, $nombre, $detalle, $precio, $stock, $id_categoria, $id_proveedor, $imagen) {
        $consulta = "UPDATE producto SET codigo='$codigo', nombre='$nombre', detalle='$detalle', precio='$precio', stock='$stock', id_categoria='$id_categoria', id_proveedor='$id_proveedor', imagen='$imagen' WHERE id='$id_producto'";
        $sql = $this->conexion->query($consulta);
        return $sql;
    }*/
